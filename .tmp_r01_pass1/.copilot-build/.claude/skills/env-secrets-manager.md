...
description: "Use when managing environment variables, .env files, secrets rotation, vault configuration, or Infisical/Doppler setup. Triggers on secrets management, env var configuration, credential rotation, or secret scanning tasks."
---
