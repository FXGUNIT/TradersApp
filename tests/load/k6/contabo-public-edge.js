 ...
 *   - traders.tradergunit.is-a.dev     -> Caddy edge
 *   - bff.traders.tradergunit.is-a.dev -> BFF direct host
 *   - api.traders.tradergunit.is-a.dev -> ML Engine direct host
 *
 ...
 *   TRADERSAPP_BASE_URL=https://traders.tradergunit.is-a.dev \
 *   BFF_BASE_URL=https://bff.traders.tradergunit.is-a.dev \
 *   ML_BASE_URL=https://api.traders.tradergunit.is-a.dev \
 *   k6 run tests/load/k6/contabo-public-edge.js
 */
...
const TRADERSAPP_BASE_URL = (__ENV.TRADERSAPP_BASE_URL || 'https://traders.tradergunit.is-a.dev').replace(/\/$/, '');
const BFF_BASE_URL = (__ENV.BFF_BASE_URL || 'https://bff.traders.tradergunit.is-a.dev').replace(/\/$/, '');
const ML_BASE_URL = (__ENV.ML_BASE_URL || 'https://api.traders.tradergunit.is-a.dev').replace(/\/$/, '');
