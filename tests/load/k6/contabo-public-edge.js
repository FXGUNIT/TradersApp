 ...
 *   - tradergunit.is-a.dev         -> Caddy edge
 *   - bff.tradergunit.is-a.dev     -> BFF direct host
 *   - api.tradergunit.is-a.dev     -> ML Engine direct host
 *
 ...
 *   TRADERSAPP_BASE_URL=https://tradergunit.is-a.dev \
 *   BFF_BASE_URL=https://bff.tradergunit.is-a.dev \
 *   ML_BASE_URL=https://api.tradergunit.is-a.dev \
 *   k6 run tests/load/k6/contabo-public-edge.js
 */
...
const TRADERSAPP_BASE_URL = (__ENV.TRADERSAPP_BASE_URL || 'https://tradergunit.is-a.dev').replace(/\/$/, '');
const BFF_BASE_URL = (__ENV.BFF_BASE_URL || 'https://bff.tradergunit.is-a.dev').replace(/\/$/, '');
const ML_BASE_URL = (__ENV.ML_BASE_URL || 'https://api.tradergunit.is-a.dev').replace(/\/$/, '');
