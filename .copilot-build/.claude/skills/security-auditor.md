...
description: "Use when auditing code for security vulnerabilities, reviewing OWASP Top 10 risks, checking for injection flaws, XSS, CSRF, authentication issues, or compliance with security frameworks. Triggers on security audit, vulnerability scan, penetration testing, DevSecOps, SAST/DAST review, or compliance check tasks."
risk: unknown
source: community
