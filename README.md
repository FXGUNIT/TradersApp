...
| Requirements and blockers | [SPEC.md](SPEC.md) |
| Active production runbook | [docs/P26_Contabo_Deployment_Plan.md](docs/P26_Contabo_Deployment_Plan.md) |
...
- [Local Dev Guide](docs/LOCAL_DEV.md) - Local development setup
- [Deployment Guide](docs/DEPLOYMENT.md) - Current production deployment overview
- [Contabo Production Runbook](docs/P26_Contabo_Deployment_Plan.md) - Active production cutover path
- [Architecture ADR Register](docs/adr/README.md) - All 18 architectural decisions
- [MLflow + MLOps](docs/MLOPS_MLFLOW.md) - Experiment tracking and model registry
- [CI/CD: Gitea + Woodpecker](docs/CICD_GITEA_WOODPECKER.md) - Build and deploy pipeline
...
- **Airflow + Great Expectations** for data quality and retraining
- **Prometheus + Grafana + Loki + Jaeger** for observability
- **GitHub Actions + Docker Compose + Contabo** for the active production path
...
| [SPEC.md](SPEC.md) | Requirements and blockers |
