...
description: "Use when profiling CPU, memory, or I/O bottlenecks, generating flamegraphs, analyzing bundle sizes, optimizing slow database queries, detecting memory leaks, or running load tests. Triggers on performance profiling, latency investigation, memory leak detection, bundle analysis, or load testing tasks."
---
