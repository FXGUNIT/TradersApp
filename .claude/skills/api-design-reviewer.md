...
description: "Use when reviewing API contracts, endpoint designs, REST/GraphQL schemas, request/response shapes, or validating API backwards compatibility. Triggers on API review, endpoint audit, contract validation, or schema review tasks."
---
