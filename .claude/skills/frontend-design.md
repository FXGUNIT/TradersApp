...
description: "Use when designing frontend UI components, creating responsive layouts, implementing design systems, or building accessible web interfaces. Triggers on UI design, component architecture, CSS/Tailwind styling, responsive design, or accessibility implementation tasks."
risk: unknown
source: community
