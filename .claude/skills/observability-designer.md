...
description: "Use when designing observability stacks, setting up Prometheus/Grafana dashboards, configuring distributed tracing (Jaeger/Zipkin), or creating alerting rules. Triggers on monitoring setup, metrics design, tracing configuration, log aggregation, SLO/SLI definition, or alerting tasks."
---
