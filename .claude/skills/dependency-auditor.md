...
description: "Use when auditing npm/pip dependencies, checking for vulnerabilities, outdated packages, license compliance, or supply chain security. Triggers on dependency audit, package update, vulnerability scan, or supply chain review tasks."
---
