...
- [k8s_kafka_audit_2026_04_08.md](k8s_kafka_audit_2026_04_08.md) — k3s v1.34.6 running on WSL Ubuntu, PV inventory, Kafka all 5 consumers wired, SQLite data loss fix applied, kubectl wrapper at .claude/kubectl
