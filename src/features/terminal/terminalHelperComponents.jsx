...
export function CountdownBanner({ ist }) {
  ...
  return (
    <div style={{
      ...
      gap: 16,
      padding: "12px 28px",
      background: urgent ? SOFT.dangerBg : ist.isOpen ? SOFT.successBgQuiet : SOFT.dangerBgQuiet,
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        top: 8,
        right: 8,
        background: isActive ? T.blue + "25" : SOFT.overlayMuted,
...
export function HourlyHeatmap({ hourlyHeatmap }) {
  ...
  return (
    <div style={{
      padding: "16px 20px",
      background: SOFT.overlaySoft,
      border: `1px solid ${SOFT.borderSubtle}`,
      borderRadius: 10,
      marginBottom: 16
    }}
        ...
        {hrs.map((utcH, i) => {
          ...
          if (!st || !st.total) {
            return (
              <div key={utcH} style={{ flex: 1, minWidth: 40, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
                <div style={{ height: 40, background: SOFT.emptyBar, borderRadius: 4, width: "100%" }} />
          ...
          return (
            <div key={utcH} style={{ flex: 1, minWidth: 40, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
              ...
              >
                <span style={{ color: SOFT.inverseText, fontSize: 9, fontWeight: 700 }}>{upPct > 0 ? Math.round(upPct) : ""}</span>
              </div>
