...
const TermsOfService = ({ onClose }) => {
  const T = {
    bg: "var(--aura-surface-elevated, #FFFFFF)",
    fg: "var(--aura-text-primary, #111827)",
    muted: "var(--aura-text-secondary, #64748B)",
    blue: "var(--aura-accent-primary, #2563EB)",
    border: "var(--aura-border-subtle, #E2E8F0)",
  };
      ...
      >
        ...
        <div style={{ lineHeight: 1.8, color: T.fg, fontSize: 14 }}>
          ...
          <section style={{ marginBottom: 32 }}>
            ...
            <p>
              By accessing and using the Traders Regiment platform ("Platform"),
          ...
          <section style={{ marginBottom: 32 }}>
            ...
            <p>
              Traders Regiment may revise these terms of service at any time
          ...
          <section style={{ marginBottom: 32 }}>
            ...
            <p>
              ...
              performance is not indicative of future results. Performance
              results represent past performance and do not guarantee future
              results. You acknowledge that you understand these risks and
          ...
          <section style={{ marginBottom: 32 }}>
            ...
            <p>
              ...
              accordance with the laws of the jurisdiction in which Traders
              Regiment operates, and you irrevocably submit to the exclusive
          ...
          <section>
            ...
            <p>
              ...
              us at legal@traders-regiment.com
            </p>
          </section>
        </div>
        ...
        <button
          ...
          onMouseOver={(e) =>
            (e.target.style.background =
              "var(--aura-accent-primary-hover, #1d4ed8)")
          }
