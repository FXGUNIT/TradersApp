...
Options:
  --base-env FILE          Base env file from OVH_APP_ENV or Infisical output
  ...
  --domain HOST            public root host (default: 173.249.18.14.sslip.io)
  --bff-host HOST          BFF public hostname
  --api-host HOST          ML/API public hostname
...
REDIS_HOST=redis
REDIS_PORT=6379
BOARD_ROOM_STORAGE_MODE=redis
SESSION_STORAGE_MODE=redis
ADMIN_MASTER_EMAIL=admin-owner@example.invalid
ADMIN_MFA_EMAILS=admin-one@example.invalid,admin-two@example.invalid,admin-three@example.invalid
