...
Options:
  ...
  --domain HOST            tradergunit.is-a.dev root domain
  --bff-host HOST          bff.tradergunit.is-a.dev public hostname
  --api-host HOST          api.tradergunit.is-a.dev public hostname
